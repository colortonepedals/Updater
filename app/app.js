...
var app = new Vue({
    ...
    <b-row align="center" class="app_column">
        <div>
            ...
            <li><p> <img src="img/colortone_Color_Logo_2023_sm_240.jpeg" alt="Pineapple" style="width:170px;height:170px;"> </p></li>
        ...
        <b-row align="between">
            <b-col align="center" class="app_column">
                <b-container>
                    <hr>
                    <b-row class="p-2">
                        <h4> Select Pedal and Latest Firmware Version from menus below.</h4>
                    ...
                    <hr>
                    <b-row class="p-2">
                        <h4> If we have sent you a custom build you can load the firmware here from your computer </h4>
                            <b-form-file
                                id="firmwareFile"
